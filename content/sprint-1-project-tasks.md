...
| S1 - Deploy unico na Vercel (sem servicos externos) | In Progress | Sprint 1 | Alta | Infra | Consolidar MVP para rodar somente no front, com estado local persistente. | Aplicacao sobe em um unico deploy e fluxo principal funciona sem banco externo. |
